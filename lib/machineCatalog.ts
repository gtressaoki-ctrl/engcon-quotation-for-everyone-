...
export const MACHINE_LIST: MachineListEntry[] = [
  ...
  { maker: 'CAT', model: '305 CR', s_standard: 'S40', ec_primary: 'EC206B', dc: 'DC2' },
  { maker: 'CAT', model: '305 SR', s_standard: 'S40', ec_primary: 'EC206B', dc: 'DC2' },
  { maker: 'CAT', model: '305.5 CR', s_standard: 'S40', ec_primary: 'EC206B', dc: 'DC2' },
